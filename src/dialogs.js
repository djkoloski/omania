var DIALOGS = [
	[
		...
		{
			speaker: 'Talha',
			message: 'No, this is my first. When the army came through my town and I heard Sultan bin Saif speak of tearing Oman free from Portugal\'s grip, I could not stay still.'
		},
		{
			speaker: 'Aazaad',
	...
	[
		{
			speaker: 'Aazaad',
			message: 'Sultan bin Saif will shout a warning to us to either move to up, down, left, right, or tight in the center, so that the army is not hit by obstacles.'
		},
		{
			speaker: null,
			message: 'Press W, A, S, D, or Spacebar to command the soldiers'
		}
	],
	[
		{
